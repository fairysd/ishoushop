...
E_D("replace into `ecs_brand` values('71','小白熊','1407706202875781317.jpg','','http://','50','1');");
E_D("replace into `ecs_brand` values('72','balabala','1407706190622930743.jpg','','http://','50','1');");
E_D("replace into `ecs_brand` values('73','芭比','1407706273821564499.jpg','','http://','50','1');");

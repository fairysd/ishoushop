...
E_D("replace into `ecs_link_goods` values('47','7','0','1');");
E_D("replace into `ecs_link_goods` values('47','12','0','1');");
E_D("replace into `ecs_link_goods` values('47','10','0','1');");
E_D("replace into `ecs_link_goods` values('47','21','0','1');");
E_D("replace into `ecs_link_goods` values('47','22','0','1');");
E_D("replace into `ecs_link_goods` values('47','20','0','1');");
E_D("replace into `ecs_link_goods` values('47','14','0','1');");
E_D("replace into `ecs_link_goods` values('47','23','0','1');");
E_D("replace into `ecs_link_goods` values('47','16','0','1');");
E_D("replace into `ecs_link_goods` values('132','23','0','1');");
E_D("replace into `ecs_link_goods` values('132','13','0','1');");
E_D("replace into `ecs_link_goods` values('132','46','0','1');");
E_D("replace into `ecs_link_goods` values('132','20','0','1');");
E_D("replace into `ecs_link_goods` values('144','75','0','1');");
E_D("replace into `ecs_link_goods` values('144','77','0','1');");
E_D("replace into `ecs_link_goods` values('144','78','0','1');");
E_D("replace into `ecs_link_goods` values('144','72','0','1');");
E_D("replace into `ecs_link_goods` values('144','143','0','1');");
E_D("replace into `ecs_link_goods` values('144','73','0','1');");
E_D("replace into `ecs_link_goods` values('144','151','0','1');");

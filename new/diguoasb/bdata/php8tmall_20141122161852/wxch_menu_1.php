...
E_D("replace into `wxch_menu` values('15','click','2','砸金蛋','zjd','3');");
E_D("replace into `wxch_menu` values('16','click','2','大转盘','dzp','3');");
E_D("replace into `wxch_menu` values('17','view','2','首页','http://shop.hejin.com/ectouchnew/','3');");
E_D("replace into `wxch_menu` values('18','view','2','PHP源码吧','http://php8.taobao.com/','3');");

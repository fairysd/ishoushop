...
E_D("replace into `ecs_account_log` values('41','11','0.00','0.00','800','800','1407272866','订单 2014080697752 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('42','11','0.00','0.00','0','-100','1407272960','支付订单 2014080643288','99');");
E_D("replace into `ecs_account_log` values('43','11','0.00','0.00','0','-1','1407273005','参加夺宝奇兵夺宝奇兵活动 ','99');");
E_D("replace into `ecs_account_log` values('44','13','0.00','0.00','89','89','1415297752','订单 2014110790960 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('45','13','0.00','0.00','-89','-89','1415300401','由于退货或未发货操作，退回订单 2014110790960 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('46','13','0.00','0.00','89','89','1415300409','订单 2014110790960 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('47','13','0.00','0.00','89','89','1415301405','订单 2014110790960 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('48','13','0.00','0.00','89','89','1415301501','订单 2014110790960 赠送的积分','99');");

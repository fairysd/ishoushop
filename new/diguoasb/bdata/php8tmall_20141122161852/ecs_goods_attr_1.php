...
E_D("replace into `ecs_goods_attr` values('324','47','185','黑色','');");
E_D("replace into `ecs_goods_attr` values('325','47','185','粉色','');");
E_D("replace into `ecs_goods_attr` values('326','47','185','金色','');");
E_D("replace into `ecs_goods_attr` values('327','47','185','白色','');");
E_D("replace into `ecs_goods_attr` values('334','47','223','M【现货】','');");
E_D("replace into `ecs_goods_attr` values('333','47','223','s【现货】','');");
E_D("replace into `ecs_goods_attr` values('335','47','223','L【现货】','');");
E_D("replace into `ecs_goods_attr` values('336','47','223','xL【现货】','');");
E_D("replace into `ecs_goods_attr` values('337','47','223','xxL【热卖抢购中】','');");
E_D("replace into `ecs_goods_attr` values('338','47','181','12','0');");
E_D("replace into `ecs_goods_attr` values('339','47','184','1345','0');");
E_D("replace into `ecs_goods_attr` values('340','47','186','1600万','0');");
E_D("replace into `ecs_goods_attr` values('341','47','187','TFT','0');");
E_D("replace into `ecs_goods_attr` values('342','47','188','240×320 像素','0');");
E_D("replace into `ecs_goods_attr` values('343','47','189','240','0');");
E_D("replace into `ecs_goods_attr` values('344','46','223','s【现货】','');");
E_D("replace into `ecs_goods_attr` values('345','46','210','线控耳机','');");
E_D("replace into `ecs_goods_attr` values('346','46','173','GSM,850,900,1800,1900','0');");
E_D("replace into `ecs_goods_attr` values('347','132','185','黑色','0');");
E_D("replace into `ecs_goods_attr` values('348','132','185','白色','100');");
E_D("replace into `ecs_goods_attr` values('349','132','186','1600万','0');");
E_D("replace into `ecs_goods_attr` values('350','132','187','TFT','0');");
E_D("replace into `ecs_goods_attr` values('351','132','188','320×240 像素','0');");
E_D("replace into `ecs_goods_attr` values('352','132','180','发顺丰大师的','0');");
E_D("replace into `ecs_goods_attr` values('353','132','181','发顺丰大师的','0');");
E_D("replace into `ecs_goods_attr` values('354','132','182','经济型包装','0');");
E_D("replace into `ecs_goods_attr` values('355','132','183','dwerqw','0');");
E_D("replace into `ecs_goods_attr` values('356','132','178','翻盖','0');");
E_D("replace into `ecs_goods_attr` values('357','144','186','1600万','0');");
E_D("replace into `ecs_goods_attr` values('358','144','187','TFT','0');");
E_D("replace into `ecs_goods_attr` values('359','144','188','320×240 像素','0');");
E_D("replace into `ecs_goods_attr` values('360','144','223','L【现货】','');");
E_D("replace into `ecs_goods_attr` values('361','144','223','s【现货】','');");
E_D("replace into `ecs_goods_attr` values('362','144','223','M【现货】','');");
E_D("replace into `ecs_goods_attr` values('363','144','185','黑色','0');");
E_D("replace into `ecs_goods_attr` values('364','144','185','白色','10');");
E_D("replace into `ecs_goods_attr` values('365','144','185','黑红色','20');");

...
E_D("replace into `ecs_pay_log` values('25','26','0.00','0','0');");
E_D("replace into `ecs_pay_log` values('26','27','454.00','0','0');");
E_D("replace into `ecs_pay_log` values('27','28','0.00','0','0');");
...
E_D("replace into `ecs_pay_log` values('65','27','69.00','0','0');");
E_D("replace into `ecs_pay_log` values('66','28','415.00','0','0');");
E_D("replace into `ecs_pay_log` values('67','29','183.00','0','0');");
E_D("replace into `ecs_pay_log` values('68','30','64.00','0','0');");
E_D("replace into `ecs_pay_log` values('69','31','183.00','0','0');");
E_D("replace into `ecs_pay_log` values('70','32','354.00','0','0');");
E_D("replace into `ecs_pay_log` values('71','33','506.00','0','0');");
E_D("replace into `ecs_pay_log` values('72','34','168.00','0','0');");
E_D("replace into `ecs_pay_log` values('73','35','342.50','0','0');");
E_D("replace into `ecs_pay_log` values('74','36','54.00','0','0');");
E_D("replace into `ecs_pay_log` values('75','37','351.00','0','0');");
E_D("replace into `ecs_pay_log` values('76','38','815.00','0','0');");
E_D("replace into `ecs_pay_log` values('77','39','715.00','0','0');");
E_D("replace into `ecs_pay_log` values('78','40','15.00','0','0');");
E_D("replace into `ecs_pay_log` values('79','41','100.00','0','0');");
E_D("replace into `ecs_pay_log` values('80','42','815.00','0','0');");
E_D("replace into `ecs_pay_log` values('81','43','815.00','0','0');");
E_D("replace into `ecs_pay_log` values('82','44','865.00','0','0');");
E_D("replace into `ecs_pay_log` values('83','45','792.00','0','0');");
E_D("replace into `ecs_pay_log` values('84','46','104.00','0','0');");
E_D("replace into `ecs_pay_log` values('85','47','193.00','0','0');");
E_D("replace into `ecs_pay_log` values('86','48','104.90','0','0');");
E_D("replace into `ecs_pay_log` values('87','51','183.00','0','0');");

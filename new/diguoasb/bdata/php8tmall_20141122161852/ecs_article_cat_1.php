...
E_D("replace into `ecs_article_cat` values('5','购物指南','5','','','50','0','3');");
E_D("replace into `ecs_article_cat` values('7','天猫保障','5','','配送与支付 ','50','0','3');");
E_D("replace into `ecs_article_cat` values('8','商家服务','5','','','50','0','3');");
E_D("replace into `ecs_article_cat` values('10','支付方式','5','','','50','0','3');");

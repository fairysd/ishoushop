...
E_D("replace into `wxch_prize_append` values('13','2','PHP源码吧奥迪','15');");
E_D("replace into `wxch_prize_append` values('14','2','PHP源码吧奥迪','15');");
E_D("replace into `wxch_prize_append` values('15','2','PHP源码吧奥迪','15');");
E_D("replace into `wxch_prize_append` values('16','2','PHP源码吧奥迪','15');");
E_D("replace into `wxch_prize_append` values('17','2','PHP源码吧奥迪','15');");
E_D("replace into `wxch_prize_append` values('18','2','PHP源码吧奥迪','15');");

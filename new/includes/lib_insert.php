...
function insert_history()
{
    ...
    if (!empty($_COOKIE['ECS']['history']))
    {
        ...
        while ($row = $GLOBALS['db']->fetch_array($query))
        {
            ...
            $str.='<li class="goodsimg"><a href="'.$goods['url'].'" target="_blank" class="history_pic"><img src="'.$goods['goods_thumb'].'" alt="'.$goods['goods_name'].'" /></a><p class="history_price">'.'<a  href="'.$goods['url'].'">'.$goods['shop_price'].'</a>'.'</p><a href="'.$goods['url'].'" target="_blank"  title="'.$goods['goods_name'].'" class="history_name">'.$goods['short_name'].'</a></li>';
        }

...
class ecshop extends integrate
{
     ...
     */
    function check_moblephone($phone)
    {
        if ($this->charset != 'UTF8')
        {
            $phone = ecs_iconv('UTF8', $this->charset, $phone);
        }

        $sql = "SELECT " . $this->field_id . " FROM " . $this->table($this->user_table). " WHERE mobile_phone ='" . $phone . "'";

...
/* 显示页面的action列表 */
$ui_arr = array('estimate_cancel', 'mortgageintention_cancel', 'mortgageintention_list', 'mortgageintention_list_detail', 'mortgage_list', 'mortgage_list_detail', 'estimate_list', 'estimate_list_detail', 'register', 'login', 'profile', 'order_list', 'order_detail', 'address_list', 'act_edit_address', 'collection_list',
...
elseif ($action == 'login')
{
    ...
    $smarty->assign("regFg", $_GET['regFg']);
...
elseif ($action == 'estimate_list_detail')
{
    ...
    $estimateDetail["createTime"] = date('Y-m-d H:i:s', $estimateDetail["createTime"]/1000);

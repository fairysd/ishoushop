<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:54:"/home/wwwroot/shop/new/mobile/themes/default/goods.dwt";i:1;s:65:"/home/wwwroot/shop/new/mobile/themes/default/library/comments.lbi";i:2;s:68:"/home/wwwroot/shop/new/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1467791734;s:8:"maketime";i:1467788134;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证_翡翠_玉石文玩_爱收宝</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证&pic=../images/201604/goods_img/280_G_1461266178892.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201604/thumb_img/280_thumb_G_1461266178370.jpg"  alt="飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201604/source_img/280_G_1461266178437.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(280)" style="display: inline;">0</a>
  <div class="title">
    <h1> 飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证 </h1>
  </div>
  <ul>
            <li>本店售价：<b class="price">￥9899元</b>　    <del>￥14849元</del> 
    </li>
     
	    <!-- <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥9899元</b></li> -->
        <!-- <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥9404元</b></li> -->
        <!-- <li>代销用户：<b class="price" id="ECS_RANKPRICE_3">￥8909元</b></li> -->
        <!-- <li>钻石会员：<b class="price" id="ECS_RANKPRICE_4">￥8414元</b></li> -->
      </ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(280)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        <ul class="ul1">
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(280)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(280);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201604/goods_img/280_G_1461266178892.jpg"> </div>
            <div id="right">
              <p>飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥9899元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p style="text-align: center"><img width="790" height="1040" alt="" src="/images/upload/Image/1 (25)(1).jpg" /><img width="790" height="1048" alt="" src="/images/upload/Image/1 (26)(1).jpg" /><img width="790" height="1151" alt="" src="/images/upload/Image/1 (27)(1).jpg" /><img width="790" height="524" alt="" src="/images/upload/Image/1 (28).jpg" /></p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:280;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>

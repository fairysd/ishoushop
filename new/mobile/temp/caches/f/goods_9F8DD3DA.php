<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:54:"/home/wwwroot/shop/new/mobile/themes/default/goods.dwt";i:1;s:65:"/home/wwwroot/shop/new/mobile/themes/default/library/comments.lbi";i:2;s:68:"/home/wwwroot/shop/new/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1467791682;s:8:"maketime";i:1467788082;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>3D硬足金 简约磨砂开口空心黄金手镯女款正品结婚 送女友_足金_黄金白银_爱收宝</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=3D硬足金 简约磨砂开口空心黄金手镯女款正品结婚 送女友&pic=../images/201604/goods_img/273_G_1461004606689.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201604/thumb_img/273_thumb_G_1461004606282.jpg"  alt="3D硬足金 简约磨砂开口空心黄金手镯女款正品结婚 送女友" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201604/source_img/273_G_1461004606265.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(273)" style="display: inline;">1</a>
  <div class="title">
    <h1> 3D硬足金 简约磨砂开口空心黄金手镯女款正品结婚 送女友 </h1>
  </div>
  <ul>
            <li>本店售价：<b class="price">￥2580元</b>　    <del>￥3870元</del> 
    </li>
     
	    <!-- <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥2580元</b></li> -->
        <!-- <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥2451元</b></li> -->
        <!-- <li>代销用户：<b class="price" id="ECS_RANKPRICE_3">￥2322元</b></li> -->
        <!-- <li>钻石会员：<b class="price" id="ECS_RANKPRICE_4">￥2193元</b></li> -->
      </ul>
    ...
    <form action="javascript:addToCart(273)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        ...
        <ul class="quantity">
          ...
          <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="1" type="text">
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(273)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(273);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201604/goods_img/273_G_1461004606689.jpg"> </div>
            <div id="right">
              <p>3D硬足金 简约磨砂开口空心黄金手镯女款正品结婚 送女友</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥2580元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p style="text-align: center;"><img src="/new/images/upload/Image/TB2LYuulXXXXXXsXpXXXXXXXXXX_!!2783868466.jpg" width="790" height="508" alt="" />&nbsp;<img src="/new/images/upload/Image/TB20D9qlXXXXXaHXpXXXXXXXXXX_!!2783868466.jpg" width="790" height="497" alt="" /><img src="/new/images/upload/Image/TB2S_aGlXXXXXcjXXXXXXXXXXXX_!!2783868466.jpg" width="790" height="535" alt="" /><img src="/new/images/upload/Image/TB2fpytlXXXXXXUXpXXXXXXXXXX_!!2783868466.jpg" width="790" height="503" alt="" /><img src="/new/images/upload/Image/TB2nJizlXXXXXXpXpXXXXXXXXXX_!!2783868466.jpg" width="790" height="629" alt="" /><img src="/new/images/upload/Image/TB2r25HlXXXXXb8XXXXXXXXXXXX_!!2783868466.jpg" width="790" height="505" alt="" /><img src="/new/images/upload/Image/TB29NGklXXXXXbGXpXXXXXXXXXX_!!2783868466.jpg" width="790" height="709" alt="" /></p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:273;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>

<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:57:"/home/wwwroot/shop/new/mobile/themes/default/category.dwt";i:1;s:68:"/home/wwwroot/shop/new/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1467791790;s:8:"maketime";i:1467788190;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>戒指_钻石珠宝_爱收宝</title>
  ...
  <div class="filter" style="position:static; top:0px; width:100%;">
    <form method="GET" class="sort" name="listform">
      <ul class="filter-inner">
        <li class="filter-cur"> <a href="category.php?category=346&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合 </a> </li>
        <li class=""> <a href="category.php?category=346&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=#goods_list">人气 <i class="f-ico-arrow-d"></i> </a> </li>
        <li class=""> <a href="category.php?category=346&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC#goods_list">销量</a></li>
        <li class=""> <a href="category.php?category=346&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
  ...
  <form class="hold-height" action="category.php">
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%">
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                      <li class="av-selected"> <a href="javascript:void(0);" data="0">全部</a></li>
                                                    <li> <a href="javascript:void(0);" data="182">珂洛艾伊</a></li>
                                      <input type="hidden" name="brand" value="0" />
          </ul>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                      <li class="av-selected"> <a href="javascript:void(0);" data="0|0">全部</a></li>
                                                    <li> <a href="javascript:void(0);" data="0|3000">0&nbsp;-&nbsp;3000</a></li>
                                                    <li> <a href="javascript:void(0);" data="3000|6000">3000&nbsp;-&nbsp;6000</a></li>
                                                    <li> <a href="javascript:void(0);" data="6000|9000">6000&nbsp;-&nbsp;9000</a></li>
                                                    <li> <a href="javascript:void(0);" data="9000|12000">9000&nbsp;-&nbsp;12000</a></li>
                                      <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:;">查看更多<i></i></a> </div>
                  ...
                  <div class="attr brandAttr">
        <div class="attrKey">材质详情</div>
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1503">钻石</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1666">铂金</a></li>
                                </ul>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1485">吊坠</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1330">对戒</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1657">戒指/指环</a></li>
                                </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:void(0);">查看更多<i></i></a> </div>
        </div>
      </div>
            <div class="attr brandAttr">
        <div class="attrKey">适用人群</div>
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1337">中性</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1482">女性</a></li>
                                              <li class="filter_attr"> <a href="javascript:void(0);" data="1343">男性</a></li>
                                </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:void(0);">查看更多<i></i></a> </div>
        </div>
      </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=346&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})

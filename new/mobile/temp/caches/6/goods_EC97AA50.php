<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:54:"/home/wwwroot/shop/new/mobile/themes/default/goods.dwt";i:1;s:65:"/home/wwwroot/shop/new/mobile/themes/default/library/comments.lbi";i:2;s:68:"/home/wwwroot/shop/new/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1467791671;s:8:"maketime";i:1467788071;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>足银手镯9999 北上广赵小亮同款传统光面纯银手镯子 999纯银 女_白银_黄金白银_爱收宝</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=足银手镯9999 北上广赵小亮同款传统光面纯银手镯子 999纯银 女&pic=../images/201604/goods_img/275_G_1461007985933.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201604/thumb_img/275_thumb_G_1461007985719.jpg"  alt="足银手镯9999 北上广赵小亮同款传统光面纯银手镯子 999纯银 女" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201604/source_img/275_G_1461007985468.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(275)" style="display: inline;">0</a>
  <div class="title">
    <h1> 足银手镯9999 北上广赵小亮同款传统光面纯银手镯子 999纯银 女 </h1>
  </div>
  <ul>
            <li>本店售价：<b class="price">￥155元</b>　    <del>￥233元</del> 
    </li>
     
	    <!-- <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥155元</b></li> -->
        <!-- <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥147元</b></li> -->
        <!-- <li>代销用户：<b class="price" id="ECS_RANKPRICE_3">￥140元</b></li> -->
        <!-- <li>钻石会员：<b class="price" id="ECS_RANKPRICE_4">￥132元</b></li> -->
      </ul>
  ...
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(275)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(275)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(275);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201604/goods_img/275_G_1461007985933.jpg"> </div>
            <div id="right">
              <p>足银手镯9999 北上广赵小亮同款传统光面纯银手镯子 999纯银 女</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥155元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p style="text-align: center"><img alt="" width="790" height="1330" src="/new/images/upload/Image/TB2B6IaXVXXXXaNXpXXXXXXXXXX-740180186.jpg" />&nbsp;<img alt="" width="790" height="614" src="/new/images/upload/Image/TB2sx0PcFXXXXbKXpXXXXXXXXXX_!!740180186.jpg" /></p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:275;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>  
  </div>

...
<section class="wrap">
  <div id="leftTabBox" class="loginBox">
    <div class="hd"> <span>欢迎光临，登录后体验更多服务</span>
      <ul>
        <li<?php if (! $this->_var['regFg']): ?> class="on"<?php endif; ?>><a href="javascript:void(0)">登录</a></li>
        <li<?php if ($this->_var['regFg'] == '1'): ?> class="on"<?php endif; ?>><a href="javascript:void(0)">注册</a></li>
      </ul>
    </div>
    <div class="bd" <?php if ($this->_var['regFg'] == '1'): ?> style="display:none"<?php endif; ?>>
      <ul>
        <div class="table_box">
    ...
    <div class="bd" <?php if (! $this->_var['regFg']): ?> style="display:none"<?php endif; ?>>

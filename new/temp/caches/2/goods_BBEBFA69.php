...
</script><script type="text/javascript" src="js/left_goodslist.js"></script><script type="text/javascript" src="js/miqi_goods.js"></script><script type="text/javascript" src="js/magiczoomplus.js"></script>
<script>
$(function(){
	/*放大镜缩略图左右切换效果*/
...
<div class="content_title">
  <div class="block" style="margin:0 auto">
    <div id="ur_here"> <span></span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">玉石文玩</a> <code>&gt;</code> <a href="category.php?id=359">翡翠</a> <code>&gt;</code> 透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠 </div>
  </div>
</div>
<div class="detail_main">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠">  <a href="images/201604/goods_img/285_P_1461268943149.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 440; zoom-height: 440;" onclick="window.open('gallery.php?id=285'); return false;"><img id="J_prodImg" src="images/201604/goods_img/285_G_1461268943628.jpg" alt="透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201604/goods_img/285_P_1461268943149.jpg" rel="zoom-id: Zoomer" rev="images/201604/goods_img/285_P_1461268943149.jpg"><img src="images/201604/thumb_img/285_thumb_P_1461268943619.jpg" alt="透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠"></a> </li>
...
document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000)
  ...
  <p style="float:left; padding-left:20px;"><a id="J_AddFavorite" href="javascript:collect(285)" class="favorite" ><i></i>收藏商品</a></p>
        ...
        <div class="textInfo" style="float:right">
          <form action="javascript:addToCart(285)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠</a></div>
            <div class="brief"></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text">
                  ...
                  本店价：<font  id="ECS_SHOPPRICE">￥<span>11800</span></font> </b>
                <ul class="tm-fcs-panel">
                         <li>
        <strong class="attr"> 本店价</strong> <span class="shop_price"   id="ECS_GOODS_AMOUNT" >￥<span>11800</span></span>
      </li>
       
          <li class="tm-price-panel">
                                     <span>价格</span> <font class="tm-price">￥<span>17700</span></font>
                          </li>
           </ul>
                <ul class="tm-ind-panel">
                  ...
                  <p style="display:none">
                                        注册用户：<font  id="ECS_RANKPRICE_1">￥<span>11800</span></font>
                                        vip：<font  id="ECS_RANKPRICE_2">￥<span>11210</span></font>
                                        代销用户：<font  id="ECS_RANKPRICE_3">￥<span>10620</span></font>
                                        钻石会员：<font  id="ECS_RANKPRICE_4">￥<span>10030</span></font>
                                      </p>
                  <p style="display:none">节&nbsp;&nbsp;&nbsp;省：¥5900（6.7折）</p>
              ...
              <div class="center_txt clearfix" style="margin:0 0; overflow:hidden; clear:both;">
                                <p style="display:none"><strong>购买此商品可使用：</strong><font class="f4">11800 积分</font></p>
                ...
                <div class="center_btn">
                  <div class="center_pop_btn" style="width:167px;height:33px;float:none; margin-right:10px;float:left"><a href="javascript:bool =1;addToCart(285)" style="
...
background-position: 0 0;background:url(themes/tianmao/images/que_g.png); display:block; margin-bottom:10px;"></a> </div>
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(285)"></a> </div>
                </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 285); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 285); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),285); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),285); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
<div class="box">
 <div class="box_1">
  <h3><span title="相同商品款式的商品">相同商品款式的商品</span></h3>
  <div class="boxCenterList clearfix">
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=170" target="_blank"><img src="images/201603/thumb_img/170_thumb_G_1458090703195.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=170" target="_blank" title="">新疆和田玉白玉籽料喜报三元玉牌</a><br />
      本店价：<font class="f1">￥<span>80000</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=169" target="_blank"><img src="images/201603/thumb_img/169_thumb_G_1458090459094.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=169" target="_blank" title="">新疆和田玉羊脂白玉观音挂件</a><br />
      本店价：<font class="f1">￥<span>100000</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=173" target="_blank"><img src="images/201604/thumb_img/173_thumb_G_1459968904328.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=173" target="_blank" title="">新疆和田玉白玉籽料挂件观音</a><br />
      本店价：<font class="f1">￥<span>222222</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=279" target="_blank"><img src="images/201604/thumb_img/279_thumb_G_1461260481353.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=279" target="_blank" title="">和田玉碧玉龙牌吊坠10克 玉石玉器玉牌 首饰品 礼物</a><br />
      本店价：<font class="f1">￥<span>19999</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=209" target="_blank"><img src="images/201603/thumb_img/209_thumb_G_1458686073615.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=209" target="_blank" title="">18K金镶嵌冰种翡翠吊坠 翡翠平安扣项链女 挂件正品带证书</a><br />
      本店价：<font class="f1">￥<span>1888</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=284" target="_blank"><img src="images/201604/thumb_img/284_thumb_G_1461278273233.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=284" target="_blank" title="">老坑玻璃种帝王绿翡翠观音吊坠18K白金镶钻玉坠带证书金镶玉挂件A货玉石玉器</a><br />
      本店价：<font class="f1">￥<span>900000</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=280" target="_blank"><img src="images/201604/thumb_img/280_thumb_G_1461266178370.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=280" target="_blank" title="">飘花冰种翡翠观音吊坠 男士玉观音玉佩挂件 男款玉牌玉石珠宝玉器首饰A货带证</a><br />
      本店价：<font class="f1">￥<span>9899</span></font><br />
      </li>
    </ul>
    </div>
 </div>
...
<div class="box">
 <div class="box_1">
  <h3><span title="相同商品材质的商品">相同商品材质的商品</span></h3>
  <div class="boxCenterList clearfix">
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=208" target="_blank"><img src="images/201603/thumb_img/208_thumb_G_1458685849211.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
      </li>
      <li>
      <a href="goods.php?id=208" target="_blank" title="">翡翠手镯a货 天然缅甸玉镯 飘花玉石镯子 S28带证书包邮</a><br />
      本店价：<font class="f1">￥<span>6666</span></font><br />
      </li>
    </ul>
    <ul class="clearfix">
      <li class="goodsimg">
...
<div class="box">
 <div class="box_1">
  <h3><span title="相同外观造型的商品">相同外观造型的商品</span></h3>
  <div class="boxCenterList clearfix">
    <ul class="clearfix">
      <li class="goodsimg">
      <a href="goods.php?id=169" target="_blank"><img src="images/201603/thumb_img/169_thumb_G_1458090459094.jpg" alt="" class="" style="width:180px;height:180px;" /></a>
            ...
            <div  id="no_try_record">
              ...
              <div class="t" id="shangp">基本参数：</div>
                  ...
                  <ul class="inLeft_attributes">
                      <li>商品名称:  <span  class="fit_people ">&nbsp;&nbsp;透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠</span></li>
                                                                  <li>
                       商品款式：
                        <span  class="fit_people ">挂件</span>
                      </li>
                                            <li>
                       商品材质：
                        <span  class="fit_people ">翡翠</span>
                      </li>
                                            <li>
                       商品品种：
                        <span  class="fit_people ">墨翠</span>
                      </li>
                                            <li>
                       外观造型：
                        <span  class="fit_people ">观音</span>
                      </li>
                                            
                  </ul>
                </div>
                  <div style="margin-top:20px"> <p style="text-align: center"><img alt="" width="790" height="593" src="/images/upload/Image/1 (16).jpg" /><img alt="" width="790" height="590" src="/images/upload/Image/1 (15).jpg" /><img alt="" width="790" height="593" src="/images/upload/Image/1 (17).jpg" /><img alt="" width="790" height="612" src="/images/upload/Image/1 (12)(1).jpg" /><img alt="" width="790" height="598" src="/images/upload/Image/1 (13).jpg" /></p> </div>
              </div>
                ...
                <div class="actor">
                 <a href=""> <img src="images/201604/thumb_img/285_thumb_G_1461268943236.jpg" alt="" style="width:100px;height:100px;"></a>
                </div>
                <div class="btns">
                  <div>购买过透光墨翠观音吊坠 a货老坑翡翠观音荷花莲花墨翠玉观音大挂件玉坠的顾客，在收到商品才可以对该商品发表评论</div>
              ...
              <div class=" " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:285;}554fcae493e564ee0dc75bdf2ebf94ca</div>                </div>
                </div>
                 
                 <div id="bought_note">
                 <div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:285;}554fcae493e564ee0dc75bdf2ebf94ca</div>                      </div>
            </DIV>
          </div>
        </div>
        <div class="blank"></div>

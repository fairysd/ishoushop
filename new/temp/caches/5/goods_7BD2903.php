...
<div class="content_title">
  <div class="block" style="margin:0 auto">
    <div id="ur_here"> <span></span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=292">手机数码</a> <code>&gt;</code> <a href="category.php?id=347">手机</a> <code>&gt;</code> Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7
 </div>
  </div>
</div>
<div class="detail_main">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7">  <a href="images/201603/goods_img/219_P_1458753240939.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 440; zoom-height: 440;" onclick="window.open('gallery.php?id=219'); return false;"><img id="J_prodImg" src="images/201603/goods_img/219_G_1458753240175.jpg" alt="Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201603/goods_img/219_P_1458753240939.jpg" rel="zoom-id: Zoomer" rev="images/201603/goods_img/219_P_1458753240939.jpg"><img src="images/201603/thumb_img/219_thumb_P_1458753240344.jpg" alt="Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7"></a> </li>
...
document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000)
  ...
  <p style="float:left; padding-left:20px;"><a id="J_AddFavorite" href="javascript:collect(219)" class="favorite" ><i></i>收藏商品</a></p>
        ...
        <div class="textInfo" style="float:right">
          <form action="javascript:addToCart(219)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7</a></div>
            <div class="brief"></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text">
                  ...
                  <p style="display:none" > 商品点击数：59 </p>
                  <b style="display:none">
                  
                  本店价：<font  id="ECS_SHOPPRICE">￥<span>4368</span></font> </b>
                <ul class="tm-fcs-panel">
                         <li>
        <strong class="attr"> 本店价</strong> <span class="shop_price"   id="ECS_GOODS_AMOUNT" >￥<span>4368</span></span>
      </li>
       
          <li class="tm-price-panel">
                                     <span>价格</span> <font class="tm-price">￥<span>5242</span></font>
                          </li>
           </ul>
                <ul class="tm-ind-panel">
                  ...
                  <p style="display:none">
                                        注册用户：<font  id="ECS_RANKPRICE_1">￥<span>4368</span></font>
                                        vip：<font  id="ECS_RANKPRICE_2">￥<span>4150</span></font>
                                        代销用户：<font  id="ECS_RANKPRICE_3">￥<span>3931</span></font>
                                        钻石会员：<font  id="ECS_RANKPRICE_4">￥<span>3713</span></font>
                                      </p>
                  <p style="display:none">节&nbsp;&nbsp;&nbsp;省：¥873.59（8.3折）</p>
              ...
              <div class="center_txt clearfix" style="margin:0 0; overflow:hidden; clear:both;">
                                <p style="display:none"><strong>购买此商品可使用：</strong><font class="f4">4300 积分</font></p>
                ...
                <div class="center_btn">
                  <div class="center_pop_btn" style="width:167px;height:33px;float:none; margin-right:10px;float:left"><a href="javascript:bool =1;addToCart(219)" style="
...
background-position: 0 0;background:url(themes/tianmao/images/que_g.png); display:block; margin-bottom:10px;"></a> </div>
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(219)"></a> </div>
                </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 219); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 219); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),219); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),219); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record">
              ...
              <div class="t" id="shangp">基本参数：</div>
                  ...
                  <ul class="inLeft_attributes">
                      <li>商品名称:  <span  class="fit_people ">&nbsp;&nbsp;Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7</span></li>
                      
                  </ul>
                </div>
                  <div style="margin-top:20px"> <p>&nbsp;<img src="/new/images/upload/Image/2(21).jpg" width="790" height="1708" alt="" /><img src="/new/images/upload/Image/3(37).jpg" width="790" height="1708" alt="" /><img src="/new/images/upload/Image/4(24).jpg" width="790" height="1708" alt="" /><img src="/new/images/upload/Image/6(25).jpg" width="790" height="1662" alt="" /></p> </div>
              </div>
                ...
                <div class="actor">
                 <a href=""> <img src="images/201603/thumb_img/219_thumb_G_1458753240660.jpg" alt="" style="width:100px;height:100px;"></a>
                </div>
                <div class="btns">
                  <div>购买过Samsung/三星 Galaxy S6 Edge SM-G9250 手机+7的顾客，在收到商品才可以对该商品发表评论</div>
              ...
              <div class=" " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:219;}554fcae493e564ee0dc75bdf2ebf94ca</div>
                 ...
                 <div id="bought_note">
                 <div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:219;}554fcae493e564ee0dc75bdf2ebf94ca</div>                      </div>
            </DIV>
          </div>
        </div>
        <div class="blank"></div>

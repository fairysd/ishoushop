...
<div class="content_title">
  <div class="block" style="margin:0 auto">
    <div id="ur_here"> <span></span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=352">高端腕表</a> <code>&gt;</code> 浪琴longines-名匠系列 L2.628.4.78.3 机械男表
 </div>
  </div>
</div>
<div class="detail_main">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="浪琴longines-名匠系列 L2.628.4.78.3 机械男表">  <a href="images/201603/goods_img/256_P_1459273788398.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 440; zoom-height: 440;" onclick="window.open('gallery.php?id=256'); return false;"><img id="J_prodImg" src="images/201603/goods_img/256_G_1459273788016.jpg" alt="浪琴longines-名匠系列 L2.628.4.78.3 机械男表" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201603/goods_img/256_P_1459273788398.jpg" rel="zoom-id: Zoomer" rev="images/201603/goods_img/256_P_1459273788398.jpg"><img src="images/201603/thumb_img/256_thumb_P_1459273788981.jpg" alt="浪琴longines-名匠系列 L2.628.4.78.3 机械男表"></a> </li>
                            <li > <a href="images/201603/goods_img/256_P_1459273788563.jpg" rel="zoom-id: Zoomer" rev="images/201603/goods_img/256_P_1459273788563.jpg"><img src="images/201603/thumb_img/256_thumb_P_1459273788401.jpg" alt="浪琴longines-名匠系列 L2.628.4.78.3 机械男表"></a> </li>
...
document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000)
  ...
  <p style="float:left; padding-left:20px;"><a id="J_AddFavorite" href="javascript:collect(256)" class="favorite" ><i></i>收藏商品</a></p>
        ...
        <div class="textInfo" style="float:right">
          <form action="javascript:addToCart(256)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>浪琴longines-名匠系列 L2.628.4.78.3 机械男表</a></div>
            <div class="brief"></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text">
                  ...
                  <p style="display:none" > 商品点击数：146 </p>
                  <b style="display:none">
                  
                  本店价：<font  id="ECS_SHOPPRICE">￥<span>12000</span></font> </b>
                <ul class="tm-fcs-panel">
                         <li>
        <strong class="attr"> 本店价</strong> <span class="shop_price"   id="ECS_GOODS_AMOUNT" >￥<span>12000</span></span>
      </li>
       
          <li class="tm-price-panel">
                                     <span>价格</span> <font class="tm-price">￥<span>14400</span></font>
                          </li>
           </ul>
                <ul class="tm-ind-panel">
                  ...
                  <p style="display:none">
                                        注册用户：<font  id="ECS_RANKPRICE_1">￥<span>12000</span></font>
                                        vip：<font  id="ECS_RANKPRICE_2">￥<span>11400</span></font>
                                        代销用户：<font  id="ECS_RANKPRICE_3">￥<span>10800</span></font>
                                        钻石会员：<font  id="ECS_RANKPRICE_4">￥<span>10200</span></font>
                                      </p>
                  <p style="display:none">节&nbsp;&nbsp;&nbsp;省：¥2400（8.3折）</p>
              ...
              <div class="center_txt clearfix" style="margin:0 0; overflow:hidden; clear:both;">
                                <p style="display:none"><strong>购买此商品可使用：</strong><font class="f4">12000 积分</font></p>
                ...
                <div class="center_btn">
                  <div class="center_pop_btn" style="width:167px;height:33px;float:none; margin-right:10px;float:left"><a href="javascript:bool =1;addToCart(256)" style="
...
background-position: 0 0;background:url(themes/tianmao/images/que_g.png); display:block; margin-bottom:10px;"></a> </div>
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(256)"></a> </div>
                </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 256); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 256); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),256); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),256); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record">
              ...
              <div class="t" id="shangp">基本参数：</div>
                  ...
                  <ul class="inLeft_attributes">
                      <li>商品名称:  <span  class="fit_people ">&nbsp;&nbsp;浪琴longines-名匠系列 L2.628.4.78.3 机械男表</span></li>
                      
                  </ul>
                </div>
                  <div style="margin-top:20px"> <p style="text-align: center;"><img src="/new/images/upload/Image/L2_628_4_78_3_66271.jpg" width="750" height="750" alt="" />&nbsp;<img src="/new/images/upload/Image/L2_628_4_78_3_11184.jpg" width="750" height="500" alt="" /><img src="/new/images/upload/Image/L2_628_4_78_3_60928.jpg" width="750" height="500" alt="" /><img src="/new/images/upload/Image/L2_628_4_78_3_03912.jpg" width="750" height="500" alt="" /><img src="/new/images/upload/Image/L2_628_4_78_3_50193.jpg" width="750" height="500" alt="" /></p> </div>
              </div>
                ...
                <div class="actor">
                 <a href=""> <img src="images/201603/thumb_img/256_thumb_G_1459273788142.jpg" alt="" style="width:100px;height:100px;"></a>
                </div>
                <div class="btns">
                  <div>购买过浪琴longines-名匠系列 L2.628.4.78.3 机械男表的顾客，在收到商品才可以对该商品发表评论</div>
              ...
              <div class=" " >
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:256;}554fcae493e564ee0dc75bdf2ebf94ca</div>
                </div>
                </div>
                 
                 <div id="bought_note">
                 <div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:256;}554fcae493e564ee0dc75bdf2ebf94ca</div>                      </div>
            </DIV>
          </div>
        </div>
        <div class="blank"></div>

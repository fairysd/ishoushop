      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                ...
                <tr>
                  ...
                  <td width="72%" align="left" bgcolor="#FFFFFF">
                  	<input name="people_img" type="file" value="<?php echo $this->_var['profile']['people_img']; ?>" size="25" class="inputBg" />
                  	<?php if ($this->_var['profile']['people_img']): ?><img src="themes/tianmao/images/yes.gif"><?php endif; ?>
                  </td>
                </tr>
...
?>
    ...
    <tr>
      ...
      <td width="72%" align="left" bgcolor="#FFFFFF">
      <input name="cardno" type="text" size="25" class="inputBg" maxlengt='20' value="<?php echo $this->_var['profile']['cardno']; ?>" readonly="readonly"/>
      </td>
    </tr>
                <tr>

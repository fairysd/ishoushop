<div class="accountSideTop"> <a href="user.php" <?php if ($this->_var['action'] == 'default'): ?>class="curs"<?php endif; ?>> 用户中心</a> </div>
<dl class="accountSideOption1">
  <dt class="transaction_manage"><span></span>订单中心</dt>
  <dd>
    <ul>
    ...
    <li><a href="user.php?act=estimate_list"<?php if ($this->_var['action'] == 'estimate_list' || $this->_var['action'] == 'estimate_list_detail'): ?>class="curs"<?php endif; ?>>我的回收</a></li>
    <li><a href="user.php?act=mortgageintention_list"<?php if ($this->_var['action'] == 'mortgageintention_list' || $this->_var['action'] == 'mortgageintention_list_detail'): ?>class="curs"<?php endif; ?>>我的抵押意向</a></li>
    <li><a href="user.php?act=mortgage_list"<?php if ($this->_var['action'] == 'mortgage_list' || $this->_var['action'] == 'mortgage_list_detail'): ?>class="curs"<?php endif; ?>>我的抵押（已成交）</a></li>
...
<dl class="accountSideOption1">
  <dt class="transaction_manage"><span></span>会员中心</dt>
  <dd>
    <ul>
      ...
      <?php if ($this->_var['affiliate']['on'] == 1): ?><li> <a href="user.php?act=affiliate"<?php if ($this->_var['action'] == 'affiliate'): ?>class="curs"<?php endif; ?>> <?php echo $this->_var['lang']['label_affiliate']; ?></a></li><?php endif; ?>
...
<dl class="accountSideOption1">
  <dt class="transaction_manage"><span></span>账户中心</dt>
  <dd>
    <ul>
     ...
     <!--<a href="user.php?act=group_buy"><?php echo $this->_var['lang']['label_group_buy']; ?></a>-->
      ...
      <?php if ($this->_var['show_transform_points']): ?> <li> 
...
<a href="user.php?act=logout" ><img src="themes/tianmao/images/bnt_sign.gif"></a> 
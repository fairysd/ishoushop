...
<table style="width:948px; padding:10px" >
  <?php if ($_SESSION['user_id'] > 0 && ( $this->_var['config']['use_integral'] || $this->_var['config']['use_bonus'] )): ?>
  <tr>
    <td  bgcolor="" class="nstep1_count " style="text-align:left">
  ...
  <?php endif; ?>
  <tr>
    <td  bgcolor=""  class="nstep1_count " style="text-align:left; padding:10px; font-size:13px;">
  ...
  <?php endif; ?>
  <tr>
    <td   style="text-align:right;font-weight:bold; font-size:15px; padding-right:10px;" bgcolor="" class="nstep1_count "> <?php echo $this->_var['lang']['total_fee']; ?>: <font class="f4_b" style="font-weight:bold"><?php echo $this->_var['total']['amount_formated']; ?></font>

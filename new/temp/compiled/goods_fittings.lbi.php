...
<div class="recommend_collocation lshadow" id="recommend_collocation">
...
?> 
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['tab_item']):
?>
      <blockquote style="padding:0; margin:0;" class="blockquote">
        <form name="m_goods_<?php echo $this->_var['key']; ?>" method="post" action="" onSubmit="return false;">
          <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:790px; float:left; overflow:hidden; height:180px; display:block">
            <tr>
...
?> 
              ...
              <td align="center" valign="top"  class="master" style="">
          ...
          <div class="infos">
              ...
              <div class="submit_<?php echo $this->_var['key']; ?>" style="height:30px; display:block">
              
               <p style="float:left; width:150px">套餐价：<span class="combo_price">￥0.00</span> × <input type="text" class="combo_stock" name="m_goods_<?php echo $this->_var['key']; ?>_number" value="1" size="1" style="text-align:center" /></p>
               <p class="tip_spare" style="color:#fff">省￥<strong style="miqi_priceNum; color:#fff" >0.00</strong>元</p>
              </div>
              <p class="buy_btn"><a href="javascript:addMultiToCart('m_goods_<?php echo $this->_var['key']; ?>', '<?php echo $this->_var['goods']['goods_id']; ?>')"> 套餐购买</a></p>

...
?>
       <div class="comment_list">
            ...
            <div onmouseout="this.className='comment_list_right'"  class="comment_list_right">
            <Div class="">
           
            <div class="comment_list_box">
            <div>
        <p  class="comment_ltcont">
        <?php echo $this->_var['comment']['content']; ?>
        </p> 
       
       <strong style="width:100px; float:right; font-weight:normal; overflow:hidden; text-align:center"> <?php if ($this->_var['comment']['username']): ?><?php echo htmlspecialchars($this->_var['comment']['username']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></strong></div>
       
				<?php if ($this->_var['comment']['re_content']): ?>
        <p style="color:#AF874D"><font style="font-size:12px"><?php echo $this->_var['lang']['admin_username']; ?></font><?php echo $this->_var['comment']['re_content']; ?> ( <?php echo $this->_var['comment']['add_time']; ?> )  <img src="themes/tianmao/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /></p>
				<?php endif; ?>
                </div>
                </Div>
        </div>
       ...
       <div id="pagebar" class="f_r  page_info">
        ...
        <div id="pager">
          <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_09804300_1467787607');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_09804300_1467787607']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_09804300_1467787607']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>

        
         <div id="pager" class="pagebar  page_info">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_09836100_1467787607');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_09836100_1467787607']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_09836100_1467787607']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_09866900_1467787607');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_09866900_1467787607']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_09866900_1467787607']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_09901600_1467787607');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_09901600_1467787607']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_09901600_1467787607']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>

...
<body>
<div class="bodycart_v "> <?php echo $this->fetch('library/page_header3.lbi'); ?> </div>
...
<div class="block_s"> 
  ...
  <div id="J_FilterBar" class="cart-filter-bar">
    <ul id="J_CartSwitch" class="switch-cart">
      <li class="btn-switch-cart switch-cart-0 current"><a href="#" class="J_MakePoint" ><em>全部商品</em><span class="number"></span><span class="pipe"></span></a></li>  
    </ul>
    <div class="cart-sum" style="display:none"><strong class="price  price-sum"><?php if ($this->_var['discount'] > 0): ?>
                  <?php echo $this->_var['your_discount']; ?><br />
                  <?php endif; ?>
                  <?php echo $this->_var['shopping_money']; ?>
</strong><a id="J_SmallSubmit" href="flow.php?step=checkout" class="submit-btn submit-btn-disabled">结&nbsp;算</a></div>
    <div class="wrap-line">
  ...
  <Div class="nstep_products ">
    <div class="flowBox">
      ...
      <table>
            ...
            <th bgcolor="#ffffff" colspan="2" style="width:330px; text-align:left">商品名称</th>
            <?php if ($this->_var['show_goods_attribute'] == 1): ?>
            <?php endif; ?> 
            <?php if ($this->_var['show_marketprice']): ?>
            <th bgcolor="#ffffff" style="text-align: center;" width="120">单价(元)</th>
            <?php endif; ?>
            
            <th bgcolor="#ffffff" style="text-align: center;" width="190">数量</th>
            <th bgcolor="#ffffff" style="text-align: center;" width="120">金额(元)</th>
            <th bgcolor="#ffffff" style="" width="50"><?php echo $this->_var['lang']['handle']; ?></th>
          </table>
...
?>
          ...
          <tr id="tr_goods_<?php echo $this->_var['goods']['rec_id']; ?>" class="cartList" style="border:#f00 solid 1px;">
            <td bgcolor="#ffffff" class="nstep_pbox" style="width:335px;"><?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?> 
              ...
              <p class="f_l"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="80" height="80" /></a></p>
...
?> 
              ...
              <?php endif; ?></td>
            <?php if ($this->_var['show_goods_attribute'] == 1): ?>
            <td  style="width:172px;"><p class="sku-line"><?php echo nl2br($this->_var['goods']['goods_attr']); ?></p></td>
            <?php endif; ?> 
            <?php if ($this->_var['show_marketprice']): ?>
            <td  bgcolor="#ffffff"><p class="price-line"><em class="price-original"><?php echo $this->_var['goods']['market_price']; ?></em></p>
            <?php endif; ?>
            <p class="price-line"><em class="price-now"><?php echo $this->_var['goods']['goods_price']; ?></em></p></td>
            <td bgcolor="#ffffff" style="width:160px"><?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?> 
            <div  class="item-amount">
              <a  href="javascript:void(0)" onclick="changenum(<?php echo $this->_var['goods']['rec_id']; ?>,1)" class="add">+</a>
              <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="1"class="shuliang" style="text-align:center "    onchange="change_goods_number(<?php echo $this->_var['goods']['rec_id']; ?>,this.value)"/>
               <a href="javascript:void(0)" onclick="changenum(<?php echo $this->_var['goods']['rec_id']; ?>,-1)" class="sub">-</a></div>
              <?php else: ?> 
              <?php echo $this->_var['goods']['goods_number']; ?> 
              <?php endif; ?></td>
            <td  bgcolor="#ffffff" id="goods_subtotal_<?php echo $this->_var['goods']['rec_id']; ?>" class="chkprice "><?php echo $this->_var['goods']['subtotal']; ?></td>
            <td  bgcolor="#ffffff" ><a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " style=" display:block; text-align:center"><?php echo $this->_var['lang']['drop']; ?></a> 
              <?php if ($_SESSION['user_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?> 
              <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_to_collect&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " style=" display:block;text-align:center"><?php echo $this->_var['lang']['drop_to_collect']; ?></a> 
              <?php endif; ?></td>
          </tr>
          ...
          <tr>
            <td bgcolor="#ffffff" id="total_desc" class="nstep1_count">
               <div class="float-bar-wrapper">
                ...
                <div class="btn-area"><a class="submit-btns" href="flow.php?step=checkout">结算</a></div>
                <div class="price-sum"> 
                  <?php if ($this->_var['discount'] > 0): ?> 
                  <?php echo $this->_var['your_discount']; ?><br />
                  <?php endif; ?> 
                  <?php echo $this->_var['shopping_money']; ?> </div>
  ...
  <div class="block_s" > 
    ...
    <div class="buytab_a clearfix " >
      <div class="buytab clearfix">
        <div id="tabnavs">
          <h2 class="nstep1_tit2"></h2>
          <p class="recommendNav">您可能感兴趣的商品</p>
        </div>
        <form action="flow.php" method="post" class="postform">
...
?>
              ...
              <li> <a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['fittings']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['fittings']['name']); ?>" width="160" height="160" /></a>
                  <div class="price"><strong><?php echo $this->_var['fittings']['fittings_price']; ?></strong></div>
                  <div class="title">
               <a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['fittings']['goods_name']); ?>" class="hpink"><?php echo htmlspecialchars($this->_var['fittings']['short_name']); ?></a></div>
			...
			<script type="text/javascript">
		jQuery(".picScroll-left3").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"left",autoPlay:true,scroll:5,vis:5});
		</script>
		</div>
...
?>
            ...
            <li> <a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" border="0" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" width="158" height="158"/></a> <a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="hpink"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a>
              <div class="hde">
              ...
              <div class="sucess_joinCart" id="addtocartdialog_retui_<?php echo $this->_var['goods']['id']; ?>_best"> </div>
            </li>
...
?><br />
          ...
          <tr>
            ...
            <td align="center" bgcolor="#ffffff"><input type="image" src="themes/tianmao/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
          </tr>
          <?php endif; ?>
        </table>
    ...
    <div class="buytab_a">
      <div class="nstep2_con">
        ...
        var flow_no_shipping = "<?php echo $this->_var['lang']['flow_no_shipping']; ?>";
          ...
          <h2 class="nstep1_tit3"><span style="text-align:left; float:left"><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php"  style="font-weight:normal;float:right;margin-right:10px;" class="f14 pink"><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?></h2>
          <div class="nstep_products" style="margin-top:10px;padding-bottom:9px;">
...
?>
              <tr >
                <td bgcolor="#ffffff" style="width:450px;"><?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] == 'package_buy'): ?> 
    ...
    foreach ($_from AS $this->_var['package_goods_list']):
?> 
                    <a href="goods.php?id=<?php echo $this->_var['package_goods_list']['goods_id']; ?>" target="_blank" class=" nstep_pbox "><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"  target="_blank"  width="78" height="78"/></a> <a href="goods.php?id=<?php echo $this->_var['package_goods_list']['goods_id']; ?>" target="_blank" class="nstep_name"><?php echo $this->_var['package_goods_list']['goods_name']; ?></a> 
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
                  </div>
                  
                  <?php else: ?> 
                  <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class=" nstep_pbox xuxian "> <img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" target="_blank" width="78" height="78" /></a> <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="nstep_name"><?php echo $this->_var['goods']['goods_name']; ?></a> 
                  <?php if ($this->_var['goods']['parent_id'] > 0): ?> 
                  ...
                  <?php endif; ?> 
                  <?php endif; ?> 
                  <?php if ($this->_var['goods']['is_shipping']): ?>(<span style="color:#ff4560"><?php echo $this->_var['lang']['free_goods']; ?></span>)<?php endif; ?></td>
          ...
          <div class="blank"></div>
          <h2 class="nstep1_tit3"><span style="text-align:left; float:left"><?php echo $this->_var['lang']['consignee_info']; ?></span><a href="flow.php?step=consignee" style="font-weight:normal;float:right;margin-right:15px;" class="f14 pink"><?php echo $this->_var['lang']['modify']; ?></a></h2>
          <div class="nstep2_ctent">
            <div  style="line-height:30px;">
              <table  style="width:948px;border:1px #e5e5e5 solid;margin:5px auto;">
                <tr   class="nstepn_opt optbg" >
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
                  <td style=""><?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?></td>
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['email_address']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['email']); ?></td>
                </tr>
                <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
                <tr  class="nstepn_opt optbg">
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['detailed_address']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['address']); ?> </td>
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['postalcode']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?></td>
                </tr>
                <?php endif; ?>
                <tr  class="nstepn_opt optbg">
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['phone']; ?>:</td>
                  <td bgcolor=""><?php echo $this->_var['consignee']['tel']; ?> </td>
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['backup_phone']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?></td>
                </tr>
                <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
                <tr class="nstepn_opt optbg">
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['sign_building']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?> </td>
                  <td bgcolor="" width="14%" class="txt_r"><?php echo $this->_var['lang']['deliver_goods_time']; ?>:</td>
                  <td bgcolor=""><?php echo htmlspecialchars($this->_var['consignee']['best_time']); ?></td>
                </tr>
                <?php endif; ?>
              </table>
            </div>
...
?>
              <tr>
                <td valign="top" class="weiruan " bgcolor="#ffffff"><input type="radio" name="pack" value="<?php echo $this->_var['pack']['pack_id']; ?>" <?php if ($this->_var['order']['pack_id'] == $this->_var['pack']['pack_id']): ?>checked="true"<?php endif; ?> onclick="selectPack(this)" /></td>
                ...
                <td valign="top"class="weiruan " bgcolor="#ffffff" align="center"><?php if ($this->_var['pack']['pack_img']): ?> 
...
?>
              <tr>
                <td valign="top" class="weiruan " bgcolor="#ffffff"><input type="radio" name="card" value="<?php echo $this->_var['card']['card_id']; ?>" <?php if ($this->_var['order']['card_id'] == $this->_var['card']['card_id']): ?>checked="true"<?php endif; ?> onclick="selectCard(this)"  /></td>
                ...
                <td valign="top" class="weiruan " align="center" bgcolor="#ffffff"><?php if ($this->_var['card']['card_img']): ?> 
              ...
              <tr>
                ...
                <td bgcolor="#ffffff"class="weiruan " colspan="3"><textarea id="card_message" disabled="true" name="card_message" cols="60" rows="3" style="width:auto; border:1px solid #ccc;"><?php echo htmlspecialchars($this->_var['order']['card_message']); ?></textarea></td>
              </tr>
            </table>
          </div>
          <div class="blank"></div>
          ...
          <div class="nstep_products" style="margin-top:5px;padding-bottom:9px;">
            <table style="width:948px;border:1px #e5e5e5 solid;margin:5px auto;">
              ...
              <tr>
                ...
                <td class="weiruan "  bgcolor="#ffffff"> <?php echo $this->_var['lang']['select_bonus']; ?>
...
?>
              ...
              <tr>
                ...
                <td class="weiruan "  bgcolor="#ffffff"><?php if ($this->_var['inv_type_list']): ?> 
...
?>
          ...
          <div class="nstep_products">
            <Div style="width:948px;border:1px #ccc solid;margin:5px auto 0 auto;"> <?php echo $this->fetch('library/order_total.lbi'); ?>
              <div align="center" style="margin:8px auto;">
                <input type="submit" class="orderconfirmBtn" value="确认订单" />
  ...
  <div class="block_s">
    ...
    <div class="buytab_a" >
      <div class="nstep2_con orderok">
        ...
        <p class="orderpayinfo"> <?php echo $this->_var['order']['pay_desc']; ?> 
      ...
      <div class=" ">
              ...
              <div class="coLogin_one">
                ...
                <div class="">
                  <div class="coLogin_txt_all">
                    <input name="username" type="text" class="coLogin_txts" id="username" onblur="is_registered(this.value);" />
                  </div>
                </div>
                <span id="username_notice" style="color:#ff4560"> </span> </div>
              <div class="coLogin_one">
                <p><?php echo $this->_var['lang']['email_address']; ?>：</p>
                <div class="">
                  <div class="coLogin_txt_all">
                    <input name="email" type="text" class="coLogin_txts" id="email" onblur="checkEmail(this.value);" />
                  </div>
                </div>
                <span id="email_notice" style="color:#ff4560"></span> </div>
              <div class="coLogin_one">
                <p><?php echo $this->_var['lang']['password']; ?>：</p>
                <div class="">
                  <div class="coLogin_txt_all">
                    <input name="password" class="coLogin_txts" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" />
                  </div>
                </div>
                <span style="color:#ff4560" id="password_notice"></span> </div>
              <div class="coLogin_one">
                <p><?php echo $this->_var['lang']['confirm_password']; ?>：</p>
                <div class="">
                  <div class="coLogin_txt_all">
                    <input name="confirm_password" class="coLogin_txts" type="password" id="confirm_password" onblur="check_conform_password(this.value);" />
                  </div>
                </div>
                <span style="color:#ff4560" id="conform_password_notice"></span> </div>
        ...
        <div class="coLoginBody_right">
          ...
          <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
            <div class="coLogin_one">
              ...
              <div class="coLoginTxt">
                <div class="coLogin_txt_all">
                  <input name="username" type="text" class="coLogin_txts" id="username" />
                </div>
              </div>
            </div>
            <div class="coLogin_one">
              ...
              <div class="coLoginTxt">
                <div class="coLogin_txt_all">
                  <input name="password" class="coLogin_txts" type="password" />
                </div>
              </div>
            </div>
            ...
            <div class="coLogin_two">
              <p></p>
              <a href="user.php?act=qpassword_name" ><?php echo $this->_var['lang']['get_password_by_question']; ?></a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" ><?php echo $this->_var['lang']['get_password_by_mail']; ?></a> </div>
            <div class="coLogin_one">
              <input type="submit" class="biLogin_btn" name="login" value="<?php echo $this->_var['lang']['forthwith_login']; ?>" style=" width:170px;" />
              <?php if ($this->_var['anonymous_buy'] == 1): ?>
              <input type="button" class="biLogin_btn" value="<?php echo $this->_var['lang']['direct_shopping']; ?>" onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" style=" width:190px; margin-left:10px;"/>
              <?php endif; ?>
          ...
          <div class="coLogin_right" style="display:none">
            <p>您也可以使用合作网站帐户登录</p>
            <ul>
              <li class="sina_ico"<a href="user.php?act=oath&type=weibo">新浪微博</a>
              </li>
